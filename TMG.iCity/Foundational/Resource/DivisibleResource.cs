...
{
    public sealed class DivisibleResource<T> : Resource<T>
    {
        public DivisibleResource(T partOf, Interval temporalExtent, Measure capacity) : base(partOf, temporalExtent, capacity)
        {
        }
